...
- 📊 Expert Power BI, avec une maîtrise opérationnelle de SQL, Python et R
...
| Projet | Description |
|---|---|
| 🌐 [**portfolio-site**](https://github.com/Mor270/portfolio-site) | Mon portfolio professionnel, publié en ligne via GitHub Pages |
| 📚 [**Ressource-Data**](https://github.com/Mor270/Ressource-Data) | Documents de référence complets : SQL, Power BI/DAX, Python, Git/GitHub |
| ⚙️ [**csv-to-json-cli**](https://github.com/Mor270/csv-to-json-cli) | Outil Node.js avec pipeline CI/CD complet (Tests → Build → Déploiement auto) |
| 🐍 [**projet**](https://github.com/Mor270/projet) | Script Python d'automatisation (organisation de fichiers) |

## 📈 Statistiques GitHub

<div align="center">

![Stats GitHub de Mor270](https://github-readme-stats.vercel.app/api?username=Mor270&show_icons=true&theme=default&hide_border=true)
...
<div align="center">
<sub>Merci de votre visite — n'hésitez pas à explorer mes dépôts ou à me contacter directement.</sub>
</div>
